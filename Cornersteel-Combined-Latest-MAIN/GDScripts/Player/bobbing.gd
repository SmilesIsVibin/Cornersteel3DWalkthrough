...
@export var bobbing_speed : float = 7.0  # Speed of the bobbing
@export var bobbing_amount : float = 0.05  # Vertical movement amount
@export var horizontal_offset : float = 0.04 # Horizontal movement amount
@export var is_bobbing_on : bool = false # flag to check the status of bobbing
...
func _ready() -> void:
	...
	# Make sure that the bobbing is disable from the start
	is_bobbing_on = false
